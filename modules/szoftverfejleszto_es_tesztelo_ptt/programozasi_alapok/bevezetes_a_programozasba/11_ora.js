...
let adatok = [
    {
        anyag: [
            ...
            ['p', 'Ismerkedés a Code.org oktatási portállal.'],
            [
                'a',
    ...
    },
    {
        anyag: [
            ['h1', `${i++}. Kártya`],
            ['h3', 'Játékos feladatok a Code.org oktatási portálon'],
            ['h4', 'Code.org'],
            ['img', '../../programozasi_alapok/images/kep_009.png'],
            ['a', 'https://code.org/', 'Code.org'],
        ],
    },
];
