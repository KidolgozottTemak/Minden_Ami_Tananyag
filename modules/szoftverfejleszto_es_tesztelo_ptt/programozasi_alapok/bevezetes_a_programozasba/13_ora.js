...
let adatok = [
    {
        anyag: [
            ...
            ['p', 'Ismerkedés a freeCodeCamp oktatási portállal.'],
            [
                'a',
    ...
    },
    {
        anyag: [
            ['h1', `${i++}. Kártya`],
            ['h3', 'Játékos feladatok a freeCodeCamp oktatási portálon'],
            ['h4', 'freeCodeCamp'],
            ['img', '../../programozasi_alapok/images/kep_010.jpg'],
            ['a', 'https://www.freecodecamp.org/', 'freeCodeCamp'],
        ],
    },
];
